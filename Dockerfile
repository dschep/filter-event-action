...
LABEL "com.github.actions.description"="Run JavaScript expressions against the parsed contents of the file at [`GITHUB_EVENT_PATH`](https://developer.github.com/actions/creating-github-actions/accessing-the-runtime-environment/#environment-variables)"
